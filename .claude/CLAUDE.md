...
|--------|-------------|--------|--------|
| `dc` | General-purpose: git workflow, distillation, video recording, markdown writing, design interviews, strategic thinking | `reset`, `clean-branches`, `distill`, `brief`, `writing`, `record`, `figma-api`, `op`, `grill` | `strategic-thinking-partner` |
